...
def compute_eer_and_tdcf(cm_score_file, args):
    asv_score_file = os.path.join(args.path_to_database, 'LA/ASVspoof2019_LA_asv_scores/ASVspoof2019.LA.asv.eval.gi.trl.scores.txt')
